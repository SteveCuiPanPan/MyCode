...
//        }
	 ...
	 * @return
	 */
	public Bitmap getBitmapFromDiskCache(String path,int reqWidth,int reqHeight) {
		if (mDiskCache != null) {
...
//	public synchronized Bitmap decodeBitmap(String fileName,int reqWidth,int reqHeight) {
//		return decodeBitmap(fileName, reqWidth,
//				reqHeight);
//	}

	public synchronized Bitmap decodeBitmap(File file,int reqWidth,int reqHeight) {
		return decodeBitmap(file.getAbsolutePath(), reqWidth,
				reqHeight);
	}
